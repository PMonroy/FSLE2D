...
#include "vflow.h" // Function to read velocities 
#include "constants.h"

int RK4(double t0, double intstep, vectorXY *point, int (*velocity)(double ,vectorXY , vectorXY* , int ), int vfield)
{
  vectorXY point2,point3,point4;
  vectorXY v1,v2,v3,v4;
